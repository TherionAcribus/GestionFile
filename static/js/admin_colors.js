// Personnalisation CSS des pages publiques : sélecteurs de couleur, copie de
// palette entre pages, et saisie d'entiers appliquée à plusieurs variables.
//
// Extrait de admin.js (Phase 8, point 1). Ce bloc représentait plus de la
// moitié du fichier alors qu'il ne sert qu'aux quatre pages d'apparence
// (page patient, annonce visuelle, et les deux pages téléphone) : il était
// téléchargé et interprété sur chaque page d'administration.
//
// Chargé via `{% block scripts_end %}`, donc APRÈS admin.js et admin_macros.js
// (`defer` respecte l'ordre du document). admin_macros.js n'appelle ces
// fonctions que depuis des gestionnaires d'évènements attachés aux éléments
// produits par les macros de couleur : sur une page sans ces éléments, aucun
// appel n'a lieu.
...
const variableDescriptions = {
    ...
    'print_error_font_color': 'Texte erreur d\'impression',
    'print_error_border_color': 'Contour texte erreur d\'impression',
    'print_error_background_color': 'Fond texte erreur d\'impression',
