...
def load_configuration(app):
    ...
    config_mappings = {
        ...
        "page_patient_print_confirmation_after": ("PAGE_PATIENT_PRINT_CONFIRMATION_AFTER", "value_bool"),
        "page_patient_scan_confirmation_after": ("PAGE_PATIENT_SCAN_CONFIRMATION_AFTER", "value_bool"),
