...
def admin_patient(tab=None):
    ...
    return render_template('/admin/patient_page.html', buttons=buttons,
                            ...
                            page_patient_print_confirmation_after = app.config['PAGE_PATIENT_PRINT_CONFIRMATION_AFTER'],
                            page_patient_scan_confirmation_after = app.config['PAGE_PATIENT_SCAN_CONFIRMATION_AFTER'],
