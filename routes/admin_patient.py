...
def admin_patient(tab=None):
    ...
    return render_template('/admin/patient_page.html', buttons=buttons,
                            ...
                            page_patient_print_fail_behavior = app.config.get('PAGE_PATIENT_PRINT_FAIL_BEHAVIOR', 'ask'),
                            page_patient_print_fail_show_retry = app.config.get('PAGE_PATIENT_PRINT_FAIL_SHOW_RETRY', True),
                            page_patient_print_fail_show_staff = app.config.get('PAGE_PATIENT_PRINT_FAIL_SHOW_STAFF', True),
                            page_patient_print_fail_abandon_timer = app.config.get('PAGE_PATIENT_PRINT_FAIL_ABANDON_TIMER', 60),
                            page_patient_interface_printing = app.config.get('PAGE_PATIENT_INTERFACE_PRINTING', ''),
                            page_patient_interface_print_failed = app.config.get('PAGE_PATIENT_INTERFACE_PRINT_FAILED', ''),
                            page_patient_interface_retry = app.config.get('PAGE_PATIENT_INTERFACE_RETRY', ''),
                            page_patient_interface_call_staff = app.config.get('PAGE_PATIENT_INTERFACE_CALL_STAFF', ''),
                            page_patient_interface_staff_called = app.config.get('PAGE_PATIENT_INTERFACE_STAFF_CALLED', ''),
                            page_patient_interface_no_ticket = app.config.get('PAGE_PATIENT_INTERFACE_NO_TICKET', ''),
                            page_patient_interface_print_failed_staff = app.config.get('PAGE_PATIENT_INTERFACE_PRINT_FAILED_STAFF', ''),
                            ...
                            circle_button_border_size=app.css_variable_manager.get_variable('patient', 'circle_button_border_size'),
                            circle_button_border_color=app.css_variable_manager.get_variable('patient', 'circle_button_border_color'),
                            circle_button_image_size=app.css_variable_manager.get_variable('patient', 'circle_button_image_size'),
                            circle_button_text_size=app.css_variable_manager.get_variable('patient', 'circle_button_text_size'),
                            ...
                            square_button_color=app.css_variable_manager.get_variable('patient', 'square_button_color'),
                            square_button_border_size=app.css_variable_manager.get_variable('patient', 'square_button_border_size'),
                            square_button_border_color=app.css_variable_manager.get_variable('patient', 'square_button_border_color'),
                            square_button_image_size=app.css_variable_manager.get_variable('patient', 'square_button_image_size'),
                            square_button_text_size=app.css_variable_manager.get_variable('patient', 'square_button_text_size'),
                            ...
                            square_cancel_button_color=app.css_variable_manager.get_variable('patient', 'square_button_color'),
                            square_cancel_button_border_size=app.css_variable_manager.get_variable('patient', 'square_button_border_size'),
                            square_cancel_button_border_color=app.css_variable_manager.get_variable('patient', 'square_button_border_color'),
                            square_cancel_button_image_size=app.css_variable_manager.get_variable('patient', 'square_cancel_button_image_size'),
                            square_cancel_button_text_size=app.css_variable_manager.get_variable('patient', 'square_button_text_size'),
                            ...
                            patient_title_background_color=app.css_variable_manager.get_variable('patient', 'patient_title_background_color'),
                            patient_title_background_height=app.css_variable_manager.get_variable('patient', 'patient_title_background_height'),
                            #explication
                            ...
                            subtitle_background_height=app.css_variable_manager.get_variable('patient', 'subtitle_background_height'),
                            ...
                            #validation
                            validation_text_font_color=app.css_variable_manager.get_variable('patient', 'validation_text_font_color'),
                            validation_text_font_size=app.css_variable_manager.get_variable('patient', 'validation_text_font_size'),
                            validation_text_border_size=app.css_variable_manager.get_variable('patient', 'validation_text_border_size'),
                            validation_text_border_color=app.css_variable_manager.get_variable('patient', 'validation_text_border_color'),
                            #validation_buttons
                            validation_button_width=app.css_variable_manager.get_variable('patient', 'validation_button_width'),
                            validation_button_height=app.css_variable_manager.get_variable('patient', 'validation_button_height'),
                            validation_button_color=app.css_variable_manager.get_variable('patient', 'validation_button_color'),
                            validation_button_border_size=app.css_variable_manager.get_variable('patient', 'validation_button_border_size'),
                            validation_button_border_color=app.css_variable_manager.get_variable('patient', 'validation_button_border_color'),
                            validation_button_text_size=app.css_variable_manager.get_variable('patient', 'validation_button_text_size'),
                            ...
                            flag_border_color=app.css_variable_manager.get_variable('patient', 'flag_border_color'),
                            )
